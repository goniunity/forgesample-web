...
//For Docking panel Display propertice...
// *******************************************
// Model Summary Panel
// *******************************************
...
ModelSummaryExtension.prototype.createUI = function () {
    ...
    modelSummaryToolbarButton.onClick = function (e) {
        ...
        _this.getAllLeafComponents(function (dbIds) {
            ...
            // Propertice is English
            var propsToList = ['Material', 'Design Status', 'Type Name'];
            // 속성정보가 한글일경우! --> Fail! How Fix?
            //var propsToList = ['치수', '재료 및 마감재', '공정'];
